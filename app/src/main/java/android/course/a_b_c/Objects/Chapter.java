package android.course.a_b_c.Objects;
...
public class Chapter {
    ...
    public static Chapter fromJson(JSONObject jsonObject) {
        try {
            ...
            List<String> ln = Converter.fromStringToLines(lines);
    ...
    public ContentValues getContentValues(){
        ...
        cv.put(Constants.LINES, Converter.combineLines(lines));
        return cv;
    }
    ...
    public String getLinesString() {
        return Converter.combineLines(lines);
    }

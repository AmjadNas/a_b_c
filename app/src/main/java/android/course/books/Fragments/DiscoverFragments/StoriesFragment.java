package android.course.books.Fragments.DiscoverFragments;

import android.app.Activity;
import android.content.Context;
import android.content.Intent;
import android.content.res.Resources;
import android.course.books.Activities.ChaptersListActivity;
import android.course.books.Activities.NewStoryActivity;
import android.course.books.Adapters.GridSpacingItemDecoration;
import android.course.books.Adapters.StoriesAdapter;
import android.course.books.DatabaseHandkers.DataHandler;
import android.course.books.Fragments.Listeners.Refreshable;
import android.course.books.Fragments.TabbedFragment;
...
import android.course.books.Fragments.Listeners.DataLoadingListener;

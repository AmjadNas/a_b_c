package android.course.books.Utils;
...
import android.course.books.Services.IResultReceiver;
        ...
        public void run() {
            while (mRunning) {
                ...
                try {
                    ...
                    NetworkConnector.getInstance().sendRequestToServer(NetworkConnector.GET_NOTIFICATIONS_JSON_REQ, DataHandler.getInstance().getUser(), new NetworkResListener() {
                        @Override
